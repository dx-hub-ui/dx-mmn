...
- Blindamos a coleta de IDs no `mark-all-read` com um type guard que ignora payloads sem `id`, evitando que respostas parcialmente tipadas (`GenericStringError`) derrubem o build quando o Supabase retorna erros em forma de linha.
