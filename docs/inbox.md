...
- O `ModalContent` recebe também a classe global `content_modal`, garantindo a mesma largura/altura dos outros modais do app independentemente dos estilos locais.
